...
import { Receipt, Plus, Pencil, Trash2, Check, X, ExternalLink, ArrowDownLeft, ArrowUpRight, Search } from "lucide-react";
import {
...
export default function TransaksiView({ transaksi, setTransaksi }) {
